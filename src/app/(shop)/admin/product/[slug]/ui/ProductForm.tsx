...
import { createUpdateProduct } from "@/action";
import { CategoryFromDB, Product, ProductImage } from "@/interfaces";
...

            {
              sizes.map(size => (
                ...
                <div key={size}
                  ...
                  className={
                    clsx(
                      'p-2 border cursor-pointer rounded-md mr-2 w-14 transition-all text-center',
                      {
